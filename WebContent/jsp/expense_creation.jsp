<body>
  <form class="container" name="expense" action="accountingServlet?operation=expense" method="POST">  <!-- non scrivo scriptlet perche l'ide mette il contentePath per me  -->
     <div class="form-row col-md-9 ml-md-auto ">
        <h2 class="text-center text-info">Aggiungi il Prodotto Acquistato:</h2><hr>
     </div>
     <hr>
     <div class="form-row col-md-9 ml-md-auto ">
        <div class="1 form-group col-xs-4">
           <label for="data_acquisto"><b id="l1">Data di Acquisto :</b></label>
           <input type="date" id="data_acquisto" name="data_acquisto" value="" min="2018-01-01" max="2020-12-31" required="required" class="form-control" />
        </div>
     </div>
     <div class="form-row col-md-9 ml-md-auto ">   
        ...
        <div class="2 form-group col-xs-4">
           ...
           <input type="text" class="form-control" name="nome_prodotto" id="customer" value="" required="required">
        </div>
     </div>
     <div class="form-row col-md-9 ml-md-auto">  
        <div class="2 form-group col-xs-4">
            <label for=""><b>Costo Unit:</b></label>
            <input type="number" id="amount" style='width:100px;' min="0.00" max="1000.00" step="0.10" value="" 
     ...
     <hr>
       <div class="form-row col-md-9 ml-md-auto text-right">
         <div class="form-group col-md-3"><br>
           <abbr title="Aggiungi Spesa per Prodotto">
            <button type="submit" class="btn btn-light">
              <img src="static/images/add_money.png" alt="Aggiungi spesa">
            </button>
           </abbr> 
         </div>
      </div>   
