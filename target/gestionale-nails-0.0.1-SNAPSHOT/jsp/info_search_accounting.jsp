   ...
   <div>
      <div class="container">
        <div class="alert alert-primary w-75 p-3  mx-auto text-center" style="width: 500px;" role="alert" >
           <strong>Nessun Conteggio trovato in base al criterio di Ricerca!</strong>&emsp;
           <p>Cerca Ancora?</p>
           <a class="btn btn-success" href="<%=request.getContextPath() + "/dispatcher?page=accounting"%>" role="button">SI</a>  
